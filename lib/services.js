...
// Cape Town, one person, Mon–Fri 7am–7pm and Sat 12–5pm SAST. No copy anywhere
// in this file may promise cover outside that, and none may invent a client,
// a testimonial or a portfolio piece.
...
export const SERVICES = [
...

  {
    ...
    faqs: [
      ...
      { q: 'What are your support hours?', a: HOURS + '. On Business Care and above you get a same-day reply on weekdays. I do not offer 24/7 or overnight cover, because I am one person and I would rather set a promise I can keep than one that sounds better in a brochure. Uptime monitoring runs continuously regardless, so an outage is caught even outside those hours.' },
